...
if [ $Lock_Alarm_Res = "reset" ]; then
    devmem 0xA0000004 32 $(($ctrlW | 0x08))
fi
...
if [ $TRIG_ph != "" ]; then
    devmem 0xA0000030 32 $(($TRIG_ph>0?$TRIG_ph:-$TRIG_ph))
fi
